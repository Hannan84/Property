<form action="{{route('properties')}}" method="GET" class="flex justify-between">
    <div class="flex w-7/12 justify-between items-center">
        <div class="flex flex-col mx-3">
            <select name="sale" id="" class="border-0 focus:ring-0">
        ...
        <div class="flex flex-col mx-3">
            <select name="type" id="" class="border-0 focus:ring-0">
        ...
        <div class="py-3 self-center border-gray-500 border"></div>
        <div class="flex flex-col mx-3">
            <select name="price" id="" class="border-0 focus:ring-0">
                ...
                <option value="500001">500000 +</option>
            </select>
        </div>
        <div class="py-3 self-center border-gray-500 border"></div>
        <div class="flex flex-col mx-3">
            <select name="bedrooms" id="" class="border-0 focus:ring-0">
